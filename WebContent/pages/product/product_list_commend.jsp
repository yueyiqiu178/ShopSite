...
<s:url var="first" action="product_findCommendProduct" namespace="/product">
<s:param name="pageNo" value="1"></s:param>


</s:url>
<s:url var="next" action="product_findCommendProduct" namespace="/product">
<s:param name="pageNo" value="pagemodel.pageNo+1"></s:param>


</s:url>
<s:url var="previous" action="product_findCommendProduct" namespace="/product">
<s:param name="pageNo" value="pagemodel.pageNo-1"></s:param>


</s:url>
<s:url var="last" action="product_findCommendProduct" namespace="/product">
